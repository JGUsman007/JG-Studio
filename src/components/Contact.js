...
const Contact = () => (
  <div className="contact-section">
    ...
    <p className="contact-page-description">
      I am open to job opportunities and side projects. Connect with me via Discord:
      <span className="contact-page-description-white"> </span>
      or email me
      <span className="contact-page-description-white"> Sajidnaseem379@gmail.com </span>
    </p>
    ...
    <div className="footer-social-links">
      ...
      <p className="footer-license-description">Copyright © 2022 Usman Bin Saleem. All Rights Reserved.</p>
    </div>
  </div>
);
